document.addEventListener('DOMContentLoaded', () => {
    // Header typing effect (for index.html)
    ...
    // Admin panel functions (for admin.html)
...
/*document.addEventListener('DOMContentLoaded', () => {
    ...
    if (welcomeText && readMoreBtn) {
        ...
        // Moved inside the if block to prevent errors on admin.html
        readMoreBtn.addEventListener('click', (e) => {
            e.preventDefault();
            const target = document.querySelector('#main-content');
            target.scrollIntoView({ behavior: 'smooth' });
...
// WARNING: Storing credentials (even hashed) in client-side JavaScript is NOT SECURE for production use.
// Anyone can view the source code and extract the hashed password or bypass the login.
// For a public-facing website, use a secure backend with hashed passwords (e.g., bcrypt) and HTTPS.
// This client-side approach is only suitable for low-risk, non-production sites.

// Configure your custom username and hashed password here
const ADMIN_USERNAME = 'AMEN'; // Change to your desired username
const ADMIN_PASSWORD_HASH = 'a417c27e626d670b4b4285b76b6555b2dc3afd77dfc2fc17a8065c274163666d'

// To generate a new password hash:
// 1. Run this in your browser console (replace 'your-password' with your password):
...
// }
// getHash('your-password').then(hash => console.log(hash));
// 2. Copy the output hash and replace ADMIN_PASSWORD_HASH above.
